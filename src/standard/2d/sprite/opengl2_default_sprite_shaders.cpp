...
JamJar::Standard::_2D::OpenGLDefaultSpriteVertexShader::OpenGLDefaultSpriteVertexShader()
    : OpenGLShader(OpenGLShaderType::VERTEX, JamJar::Standard::_2D::SpriteSystem::DEFAULT_SPRITE_VERTEX_SHADER_NAME,
                   VERTEX_SHADER_SOURCE) {}

void JamJar::Standard::_2D::OpenGLDefaultSpriteVertexShader::PerProgram(OpenGLShaderContext *context) {
...
void JamJar::Standard::_2D::OpenGLDefaultSpriteVertexShader::PerTexture(OpenGLShaderContext *context,
                                                                        JamJar::Texture *texture, GLuint textureRef) {}

void JamJar::Standard::_2D::OpenGLDefaultSpriteVertexShader::PerRenderable(OpenGLShaderContext *context,
...
JamJar::Standard::_2D::OpenGLDefaultSpriteFragmentShader::OpenGLDefaultSpriteFragmentShader()
    : OpenGLShader(OpenGLShaderType::FRAGMENT, JamJar::Standard::_2D::SpriteSystem::DEFAULT_SPRITE_FRAGMENT_SHADER_NAME,
                   FRAGMENT_SHADER_SOURCE) {}

void JamJar::Standard::_2D::OpenGLDefaultSpriteFragmentShader::PerProgram(OpenGLShaderContext *context) {}

void JamJar::Standard::_2D::OpenGLDefaultSpriteFragmentShader::PerTexture(OpenGLShaderContext *context,
                                                                          JamJar::Texture *texture, GLuint textureRef) {
...
void JamJar::Standard::_2D::OpenGLDefaultSpriteFragmentShader::PerRenderable(OpenGLShaderContext *context,
                                                                             JamJar::Texture *texture,
                                                                             JamJar::Standard::_2D::Renderable *renderable,
                                                                             GLuint textureRef) {
